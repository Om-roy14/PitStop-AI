...
class Portfolio(Base):
    ...
    teck_stack = Column(Text, nullable=False)  # <-- Changed from String(150) to Text
    github_repo = Column(String(255), nullable=True) # Increased length for long URLs too
    
    owner = relationship("User", back_populates="portfolios")

# =========================================
# EMAIL LOGS & RESEARCH (NEW)
# =========================================
class EmailLog(Base):
